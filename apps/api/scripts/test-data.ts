 ...
 * 
 * For Staging (connect to Supabase):
 *   DATABASE_URL="postgresql://..." pnpm test-data seed
 * 
 * Environment:
 *   DATABASE_URL must be set (local or staging Supabase URL)
 * 
 * Test Users Created:
 *   - alice, bob, charlie, diana, evan, fiona, george, hannah
 *   - testuser (phone: +15551230000, $1000 balance)
 *   - demo (phone: +15559990000, $500 balance)
 * 
 * To login as a test user:
 *   POST /dev/login/:username  (returns access token)
 */
